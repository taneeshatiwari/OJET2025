  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'assignment1', detail: { label: 'Assignment1', iconClass: 'oj-ux-ico-fire' } },
        { path: 'assignment2', detail: { label: 'Assignment2', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'assignment3', detail: { label: 'Assignment3', iconClass: 'oj-ux-ico-information-s' } }
      ];
